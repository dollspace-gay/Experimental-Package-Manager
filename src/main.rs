...
struct Cli {
    ...
    /// Install packages to an alternate root filesystem (e.g., /mnt/rootfs)
    ///
    /// When specified, all file operations and database updates are relative
    /// to this directory instead of /. Useful for building live ISO images
    /// or installing to chroots.
    #[arg(long, global = true)]
